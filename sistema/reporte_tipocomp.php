<?php
  ...
  class PDF extends FPDF
  {
    ...
    function Header()
    {
      ...
      $this->Cell(102.50,10,'REPORTE TIPO COMPONENTE',0,0,'C');
      $this->Ln(20);
  ...
  $consulta->query = "SELECT id_tipo_componente,descripcion FROM t_Tipo_Componente ORDER BY descripcion ASC";
  ...
  {
    $pdf->Cell(10,5,$datos2[$n]['id_tipo_componente'],1,0,'L',0);
