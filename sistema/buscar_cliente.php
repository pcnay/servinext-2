...
<body>
    ...
    <table>
      ...
      <?php
        ...
        $conectar->query = "SELECT COUNT(*) AS total_registro FROM t_Clientes WHERE (id_Clientes LIKE '%$busqueda%' OR 
...
*/
          ...
          $consulta->query = "SELECT id_Clientes,nombre FROM t_Clientes WHERE 
          id_Clientes LIKE '%$busqueda%' OR 
          nombre LIKE '%$busqueda%'
       ...
       ?>
            <tr>
              ...
              <td>
                ...
                |              
                <a class="link_delete" href="eliminar_Clientes.php?id=<?php echo $datos2[$n]['id_Clientes']; ?>">Eliminar</a>
              </td>
            </tr>
      <?php      
          } // for ($n=0;$n<count($datos2);$n++)         
