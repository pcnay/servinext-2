<?php
  ...
  class PDF extends FPDF
  {
    ...
    function Header()
    {
      ...
      $this->Cell(102.50,10,'REPORTE DE MODELO',0,0,'C');
      $this->Ln(20);
  ...
  $consulta->query = "SELECT id_modelo,descripcion FROM t_Modelo ORDER BY descripcion ASC";
  ...
  {
    $pdf->Cell(10,5,$datos2[$n]['id_modelo'],1,0,'L',0);
