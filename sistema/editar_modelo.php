<?php 
  ...
  if (!empty($_POST))
  {
    ...
    {
      $alert = '<p class="msg_error">Debes Teclear el Modelo</p>';
    }
    else
    {  
      ...
      $descripcion = $_POST['descripcion'];
          ...
          $consultar->query = "UPDATE t_Modelo SET descripcion = '$descripcion' WHERE id_modelo = $id_modelo";
        ...
        {
          $alert = '<p class="msg_save">Modelo Actualizado correctamente</p>';
        }
        else
        {
  ...
  else
  {
    ...
    $conectar->query = "SELECT id_modelo,descripcion FROM t_Modelo WHERE id_modelo = $id_modelo";
...
<body>
    ...
    <div class="form_register">
      ...
      <form action ="" method="post">
        ...
        <input type="text" name="descripcion" id = "descripcion" placeholder="Capturar Modelo" value = "<?php echo $descripcion; ?>">

        <input type="submit" value="Actualizar Modelo" class="btn_save">
