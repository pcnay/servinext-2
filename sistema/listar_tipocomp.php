...
<head>
	...
	<title>Lista De Tipo Componente</title>
</head>
<body>
    ...
    <table>
      ...
      <?php
        ...
        $conectar->query = "SELECT COUNT(*) AS total_registro FROM t_Tipo_Componente";
...
*/
          ...
          $consulta->query = "SELECT id_tipo_componente,descripcion FROM t_Tipo_Componente ORDER BY descripcion ASC LIMIT $desde,$por_pagina";
