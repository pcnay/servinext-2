<?php
  ...
  if (!empty($_POST))
  {
    ...
    {
      $alert = '<p class="msg_error">Debe Teclear un Nombre de Marca</p>';
    }
    else
    {          
      $descripcion = $_POST['descripcion'];
        ...
        $consulta->query = "INSERT INTO t_Marca(id_marca,descripcion) VALUES (0,'$descripcion')";
        ...
        {
          $alert = '<p class="msg_save">Marca Capturada correctamente</p>'; 
        }
        else
        {
          $alert = '<p class="msg_error">Error Al Capturar La Marca</p>';
        }            
    } // if(empty($_POST['descripcion']))
...
<head>
	...
	<title>Registrando La Marca</title>
</head>
<body>
    ...
    <div class="form_register">
      ...
      <form action ="" method="post">
        ...
        <input type="text" name="descripcion" id = "descripcion" placeholder="Capturar La Marca">         

        <input type="submit" value="Capturar Marca" class="btn_save">
