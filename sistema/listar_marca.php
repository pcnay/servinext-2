...
<body>
    ...
    <a href="reporte_marca.php" target="_blank" class="btn_reporte">Reporte Marcas</a>
    ...
    <table>
      ...
      <?php
        ...
        $conectar->query = "SELECT COUNT(*) AS total_registro FROM t_Marca";
...
*/
          ...
          $consulta->query = "SELECT id_marca,descripcion FROM t_Marca ORDER BY descripcion ASC LIMIT $desde,$por_pagina";
