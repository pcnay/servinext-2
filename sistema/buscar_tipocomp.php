...
<head>
	...
	<title>Lista Tipo Componente</title>
</head>
<body>
    ...
    ?>
		...
		<h1>LISTA DE TIPO COMPONENTE</h1>
    <a href="registro_tipocomp.php" class="btn_new">Capturar Tipo Componente</a>
    <a href="reporte_tipocomp.php" target="_blank" class="btn_reporte">Reporte Tipo Componente</a>

    <!-- Sección para Buscar Modelo -->
    <form action="buscar_tipocomp.php" method="get" class="form_search">
    ...
    <table>
      ...
      <?php
        ...
        $conectar->query = "SELECT COUNT(*) AS total_registro FROM t_Tipo_Componente WHERE (id_tipo_componente LIKE '%$busqueda%' OR 
...
*/
          ...
          $consulta->query = "SELECT id_tipo_componente,descripcion FROM t_Tipo_Componente WHERE 
          id_tipo_componente LIKE '%$busqueda%' OR 
          descripcion LIKE '%$busqueda%'
       ...
       ?>
            <tr>
              <td><?php echo $datos2[$n]['id_tipo_componente']; ?></td>
              <td><?php echo $datos2[$n]['descripcion']; ?></td>
              <td>
                <!-- Se pasa el "Id" del usuario al archivo "editar_usuario"-->
                <a class="link_edit" href="editar_tipocomp.php?id=<?php echo $datos2[$n]['id_tipo_componente']; ?>">Editar</a>             
                |              
                <a class="link_delete" href="eliminar_tipocomp.php?id=<?php echo $datos2[$n]['id_tipo_componente']; ?>">Eliminar</a>
              </td>
            </tr>
      <?php      
          } // for ($n=0;$n<count($datos2);$n++)         
