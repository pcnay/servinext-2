<?php
  ...
  class PDF extends FPDF
  {
    ...
    function Header()
    {
      ...
      $this->Cell(102.50,10,'REPORTE DE CLIENTES',0,0,'C');
      $this->Ln(20);
      $this->Cell(10,5,'ID',1,0,'C',0);
      $this->Cell(90,5,'NOMBRE',1,1,'C',0);
  ...
  $consulta->query = "SELECT id_Clientes,nombre FROM t_Clientes ORDER BY nombre ASC";
  ...
  {
    $pdf->Cell(10,5,$datos2[$n]['id_Clientes'],1,0,'L',0);
    $pdf->Cell(90,5,$datos2[$n]['nombre'],1,1,'L',0);
  }
